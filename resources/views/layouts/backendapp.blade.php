...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/themefy_icon/themify-icons.css') }}" />
...
<body class="crm_body_bg">
    ...
    <nav class="sidebar">
        ...
        <ul id="sidebar_menu">
            ...
            <li class="">
                <a class="has-arrow" href="#" aria-expanded="false">
                    <img src="{{ asset( 'backend/img/menu-icon/map.svg')}}" alt="">
                    <span>Maps</span>
                </a>
                <ul>
                    ...
                    <div class="header_iner d-flex justify-content-between align-items-center">
                        ...
                        <div class="header_right d-flex justify-content-between align-items-center">
                            <div class="header_notification_warp d-flex align-items-center">
                                ...
                                <li>
                                    <a class="CHATBOX_open" href="#"> <img src="{{ asset( 'backend/img/icon/msg.svg')}}" alt="">
                                        <span>01</span> </a>
                                </li>
                            </div>
                    ...
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="{{ asset( 'backend/img/staf/1.png')}}" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="{{ asset( 'backend/img/staf/2.png')}}" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="{{ asset( 'backend/img/staf/3.png')}}" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="{{ asset( 'backend/img/staf/4.png')}}" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <div class="member_thumb">
                                <img src="{{ asset( 'backend/img/staf/5.png')}}" alt="">
                            </div>
                        </a>
                    </li>
                    <li>
